...
//        [barView addSubview:episodeBtn];
        ...
        UIButton *replayBtn = [[UIButton alloc] initWithFrame:CGRectMake(0, 0, 150, 30)];
        replayBtn.tag = kReplayButton;
        replayBtn.alpha = 0.5;
        replayBtn.backgroundColor = [UIColor blackColor];
        replayBtn.hidden = YES;
        [replayBtn setTitle:@"点击重新播放" forState:UIControlStateNormal];
