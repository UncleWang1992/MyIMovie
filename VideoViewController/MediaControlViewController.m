...
//    [themeManager changeTheme:@"pink"];
    ...
    UIButton *replayBtn = (UIButton *)[self.view viewWithTag:kReplayButton];
    [replayBtn addTarget:self action:@selector(replayClicked:) forControlEvents:UIControlEventTouchUpInside];
...
- (void)mediaPlayerCompleted:(KSYPlayer *)player {
    ...
    UIButton *replayBtn = (UIButton *)[self.view viewWithTag:kReplayButton];
    replayBtn.center = self.view.center;
    replayBtn.hidden  = NO;
    
//    if ([(VideoViewController *)_delegate isCycleplay] == YES && _errorView.hidden == YES) {
////        UIButton *replayBtn = [UIButton alloc] initWithFrame:CGRectMake(CGFloat x, CGFloat y, CGFloat width, CGFloat height)
//        
//        //[_delegate play];
//    }
...
- (void)replayClicked:(UIButton *)button {
